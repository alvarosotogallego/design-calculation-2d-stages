...
P3 = impoint(gca,0,1);
setString(P3,'P3');        
P4 = impoint(gca,5.3,5);
setString(P4,'P4');
P5 = impoint(gca,5.3,3.5);
setString(P5,'P5');
P6 = impoint(gca,4,3.5);
setString(P6,'P6');
P7 = impoint(gca,0,3.5);
setString(P7,'P7');

P8 = impoint(gca,6,6);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PUNTOS 8 Y 9
setString(P8,'P8');
P9 = impoint(gca,5.3,6);
setString(P9,'P9');
