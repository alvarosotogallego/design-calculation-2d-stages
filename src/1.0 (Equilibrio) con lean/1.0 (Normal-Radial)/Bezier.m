...
P0 = impoint(gca,1.75,30);
setString(P0,'P0');
P1 = impoint(gca,1.75,11);
setString(P1,'P1');
P2 = impoint(gca,6,11);
setString(P2,'P2');
P3 = impoint(gca,11,11);
setString(P3,'P3');        
P4 = impoint(gca,4,30);
setString(P4,'P4');
P5 = impoint(gca,4,15);
...
global r z bladeTest epsilon psi rel_f Ticks02 TicksBeta2 omegaMatriz omega espesorMatriz 
...
for j = 1:100
    ...
    inter=linspace(PL1(round(-1/99*Lgth1+1/99*j*Lgth1),1), PL2(round(-1/99*Lgth2+1/99*j*Lgth2),1), 50);
    end
...
for j = 1:100
    ...
    inter=linspace(PL1(round(-1/99*Lgth1+1/99*j*Lgth1),2), PL2(round(-1/99*Lgth2+1/99*j*Lgth2),2), 50);
    end
...
axis([-5 20 10 35])
    ...
    for i = 1:50 %%%%%%%%%%%%%% ASIGNACIÓN BETA ESPESOR 1
        n = TicksBeta(i);
        endPLA = length(PL1A);
    ...
    for i = 1:50 %%%%%%%%%%%%%% ASIGNACIÓN BETA ÁLABE 2
     ...
     for i = 1:50 %%%%%%%%%%%%%% ASIGNACIÓN BETA ESPESOR 2
        n = TicksBeta2(i);
        endPLA = length(PL1A2);
