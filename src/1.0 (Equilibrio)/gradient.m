function [rV_t2,s,V_t,T_0,H,T,p,p_0,V_tot,rho,dsdq,drvtdr,dHodq,dvmdm,delta_s,delta_po] = ...
gradient(i,r,T_0,N,Vm,rho,V_t,s,H_0,Cp,R,gamma,T,SL_Mid,p_0,V_tot,p,delta_m,rV_t2,M,omega_m,ct,ch)
for j = SL_Mid:N
omega_r(j,i) = omega_m * ct * ( 2 * (r(j,i) - r(1,i) ) / (r(N,i) - r(1,i)) - 1) ^ 3;
end
for j = 1:SL_Mid-1;
omega_r(j,i) = omega_m * ch * ( 1 - 2 * (r(j,i) - r(1,i)) / (r(N,i) - r(1,i))) ^ 3;
end
for j = 1:N
