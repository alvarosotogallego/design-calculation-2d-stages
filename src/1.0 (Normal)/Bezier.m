...
global r z bladeTest epsilon psi rel_f i_alabe i_alabe2 omegaMatriz omega espesorMatriz
...
elseif gd.MENU == 3 %%%%%%%%%%%% BETA ÁLABE 1
    ...
    elseif CHECKB == 0
        ...
        setString(B1,'R1');
        B2 = impoint(gca,0.25,13.75);
        setString(B2,'R2');
        B3 = impoint(gca,0.5,27.5);
        setString(B3,'R3');
        B4 = impoint(gca,1,55);
        setString(B4,'R4');
        ...
        setString(B1P,'P1');
        B2P = impoint(gca,0.25,13.75);
        setString(B2P,'P2');
        B3P = impoint(gca,0.5,27.5);
        setString(B3P,'P3');
        B4P = impoint(gca,1,55);
        setString(B4P,'P4');
...
elseif gd.MENU == 4   %%%%%%% ESPESOR ÁLABE 1
    ...
    elseif CHECKB2 == 0
        ...
        setString(B12,'R1');
        B22 = impoint(gca,0.25,-13.75);
        setString(B22,'R2');
        B32 = impoint(gca,0.5,-27.5);
        setString(B32,'R3');
        B42 = impoint(gca,1,-55);
        setString(B42,'R4');
        
        B12P = impoint(gca,0,0); %%%%%%%%%% PUNTA
        setString(B12P,'P1');
        B22P = impoint(gca,0.25,-13.75);
        setString(B22P,'P2');
        B32P = impoint(gca,0.5,-27.5);
        setString(B32P,'P3');
        B42P = impoint(gca,1,-55);
        setString(B42P,'P4');
