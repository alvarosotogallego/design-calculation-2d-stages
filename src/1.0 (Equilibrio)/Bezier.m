...
global bladeTest epsilon psi rel_f i_alabe i_alabe2 omegaMatriz omega Nalabes
...
axis([PP0(1)-3 PP7(1)+3 PP0(2)-3 PP7(2)+3])
    ...
    for i = 1:50 %%%%%%%%%%%%%% ASIGNACIÓN BETA ÁLABE 2
        ...
        for j = 1:n  
          ...
          csvwrite('CurvaUp.dat',CurvaUp)
          csvwrite('CurvaUpMid.dat',CurvaUpMid)
          csvwrite('CurvaMid.dat',CurvaMid)
          csvwrite('CurvaMidLow.dat',CurvaMidLow)
          csvwrite('CurvaLow.dat',CurvaLow)
...
%               for j = 1:50
%                   
%                   epsilon(j,i) = 180/3.1416*epsilon(j,i) + 180/3.1416*atan(deriv(j,Theta(1:50,i),r(1:50,i),50,1));
%                   
%               end
%           end
